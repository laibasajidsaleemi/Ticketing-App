...
const DestinationDetails2 = ({ navigation }) => {
        ...
        <View style={styles.container}>
                ...
                >   
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginHorizontal: SIZES.radius, justifyContent: 'space-around' }}>
                            <Text style={{ ...FONTS.h3 }}>Nanga Parbat</Text>
            ...
            <View style={{ flex: 1.5 }}>
                ...
                <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding }}>
                    ...
                    Fairy Meadows is approachable by a fifteen kilometer-long jeepable trek starting from Raikot Bridge on Karakoram Highway to the village Tattu (Tato).
                    </Text>
                </View>
            </View>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 1, marginHorizontal: SIZES.padding, justifyContent: 'center' }}>
                            <Text style={{ ...FONTS.h1 }}>Rs.15,000/-</Text>
                        </View>
...
export default DestinationDetails2;
